            ...
            <main className="mt-20 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl ">
                  <span className="block">The Oracle of </span>
                  <span className="block text-indigo-400">Crypto Subscriptions</span>
                </h1>
                <p className="mt-3 block text-base text-gray-300 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-2xl lg:mx-0">
                Hear from those who have unlocked the oracle’s secrets. Creators and subscribers alike praise Oracoff for its flexibility, security, and the freedom it offers in the world of crypto subscriptions.
                </p>
